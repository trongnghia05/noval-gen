...
|---|---|
| Romantic pair by choice (lovers, a courtship, a marriage they both wanted) | closeness, contact, charged tension |
| Bound together against her will (a contract or forced marriage, a debt, ownership) | his claim and her resistance — a hand that holds rather than caresses, her body turned away, no softness in either face |
| Hunter and hunted | one advancing, the other giving ground or fleeing |
...
- **THE CAST IS AS THE BOOK WROTE THEM.** Every character's age comes from the MAIN
  ...
  - **Left alone the model ages faces up by five to ten years, so push the other
    way.** Give the exact number ("28-year-old", not "late twenties") and, for anyone
    under about forty, say the face is smooth and unlined. A character written at 28
    must not arrive looking 45. This has shipped: a nurse written "late 20s, tired
    eyes" was drawn with deep nasolabial folds and a hollow, middle-aged face.
  - **A worn CHARACTER is not an old FACE.** "Tired", "haggard", "weathered",
    "hollow-eyed", "exhausted" describe a state, and the model renders them as age.
    Carry that state through what it actually is — shadows under the eyes, loose
    strands of hair, a stain on a sleeve, the set of the mouth, the light — never
    through wrinkles or sagging on someone the book did not write as old.
  - Lines, grey hair and weathering belong to the characters actually written middle-
    aged or older, where they help tell the cast apart.
...
- **thumb2** — **the story's central relationship, at its most charged moment.** This
  ...
  - **Vary the pose — the staging comes from the ART DIRECTION intimacy line, and from
    nowhere else.** Realise the one you were handed, whatever it is. Any pose described
    anywhere else in these instructions — including inside a rule about what would be
    *wrong* — is an example being discussed, never a pose to draw. Reaching past your
    assigned staging for the one romance posters always use is what has made this
    catalogue's couple shots look identical to each other. Two people read as charged
    across a table, on a stair, one seated and one standing, back to back, one holding
    the other's wrist, one turning away as the other reaches.
