...
```json
{
  ...
  "source_spirit": "CHỈ điền cho REWRITE — để trống ('') cho IDEA/PREMISE.\n\nMô tả TINH THẦN TỔNG THỂ của truyện gốc gồm 4 phần:\n1. TONE & GENRE (3-5 câu): thể loại cảm xúc chủ đạo, nhịp điệu viết (chậm/nhanh), điểm nhìn (1st/3rd person), bầu không khí đặc trưng, cách tác giả gốc xây dựng tension và cảm xúc.\n2. CUNG TRUYỆN (3-5 câu, dùng VAI TRÒ — không dùng tên cụ thể): hành trình tổng thể — 'nhân vật chính bắt đầu từ...', 'phản diện thao túng bằng...', 'điểm ngoặt...', 'kết cục...'. Đủ để new_graph_builder hiểu khung cung truyện mà không bị anchored vào tên/bối cảnh gốc.\n3. NARRATIVE TEXTURE (3-5 câu — RẤT QUAN TRỌNG, quyết định cách viết): Truyện gốc **thoại-dẫn (dialogue-forward)** hay **tường-thuật-dẫn (narration-forward)** hay cân bằng? Ước lượng: một trang điển hình bao nhiêu phần trăm là ĐỐI THOẠI? Tác giả **đan xen thoại với dẫn truyện** thế nào — thoại qua lại liên tục có action beat chen giữa ('X nói... Y vỗ vai... Z đảo mắt')? hay từng khối tường thuật dài rồi mới có thoại? Câu ngắn hay dài? Có hài/châm biếm trong thoại không? Đây là ĐẶC TRƯNG texture mà bản viết lại PHẢI tái tạo — không phải nội dung.\n4. SYNTHETIC EXAMPLES (2-3 đoạn MẪU do bạn TỰ VIẾT, mỗi đoạn 3-6 câu): KHÔNG copy truyện gốc — tự sáng tác nội dung trung tính (nhân vật/bối cảnh vu vơ, không liên quan gốc) NHƯNG phải **tái hiện đúng NARRATIVE TEXTURE ở mục 3**. Nếu gốc là thoại-dẫn thì **ít nhất 2 ví dụ phải là đoạn ĐỐI THOẠI đan xen action beat** (có dấu ngoặc kép, có lời qua tiếng lại + cử chỉ chen giữa), KHÔNG được toàn văn tả cảnh. Mục đích: cho chapter-writer thấy đúng nhịp thoại/dẫn cần đạt.\n\nFormat:\nTONE: [3-5 câu]\n\nCUNG TRUYỆN: [3-5 câu dùng vai trò]\n\nNARRATIVE TEXTURE: [3-5 câu về tỷ lệ thoại/dẫn và cách đan xen]\n\nSYNTHETIC EXAMPLES:\n---\n[ví dụ 1 — tái hiện texture; nếu gốc thoại-dẫn thì đây là đoạn đối thoại đan action beat]\n---\n[ví dụ 2 — đoạn đối thoại đan xen khác, thể hiện tone/nhịp]\n---\n[ví dụ 3 (tuỳ chọn) — sắc thái khác, VD một khoảnh khắc nội tâm ngắn nếu gốc có]\n---",
